...
import com.cursofinancas.financas.model.repository.LancamentoRepository;
import com.cursofinancas.financas.service.LancamentoService;
...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getAno() == null || lancamento.getAno().toString().length() != 4) {
			throw new RegraNegocioException("Informe uma Ano válida");
		}
		...
		if(lancamento.getValor() == null || lancamento.getValor().compareTo(BigDecimal.ZERO) < 1) {
			throw new RegraNegocioException("Informe uma Valor válida");
		}
		
		if(lancamento.getTipo() == null) {
			throw new RegraNegocioException("Informe uma Tipo de lançamento");
		}
